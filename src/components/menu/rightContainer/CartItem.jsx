...
export default function CartItem(props) {
  ...
  const initialItemPrice = props.item.price //had to set initialItemPrice for when the itemPrice was updated so the new itemPrice wasn't multiplied upon increment or decrement
